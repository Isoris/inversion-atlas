...
| `SPEC_inversion_age_atlas_surface_AMENDMENT.md` | various age-class JS pieces ship (`shared/age_model_suggester.js`, `shared/busco_4d_age.js`) | the **parent** `SPEC_inversion_age_atlas_surface.md` is missing from disk (referenced from this amendment + page_evolution_age but never authored) | **AMENDMENT — parent missing** |
...
| `SPEC_page1_candidate_mode_ui.md` | `shared/candidate_mode.js` (Parallel Candidate Registry — turn 88) + page1 candidate-mode infrastructure | HANDOFF-2 detailed mode (16 PCA JSONs + 4 heatmap JSONs per candidate); page1 detailed-mode UI is not wired | **PARTIAL — detailed mode pending** |
