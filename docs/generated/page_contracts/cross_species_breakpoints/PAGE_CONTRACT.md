# cross_species_breakpoints — cross-species breakpoints — Page Capability Contract
...
This page **owns** two helpers consumed by stats_profile (synthesis stats
profile):
...
proper ES exports. stats_profile still imports via typeof guards (follow-up
task).

## Sub-modules in `cross_species_breakpoints/`
...
- **Registry doc**: `pages.registry.json` → `pages.cross_species_breakpoints._doc`
