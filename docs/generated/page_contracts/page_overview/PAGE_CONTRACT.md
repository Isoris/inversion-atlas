# page_overview — overview — Page Capability Contract
...
`<div id="page_overview" class="page"></div>` (line 9322). The tab
...
- **Registry doc**: `pages.registry.json` → `pages.page_overview._doc`
