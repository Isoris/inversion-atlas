# annotation_cockpit — annotation cockpit — Page Capability Contract
...
## Sub-modules in `annotation_cockpit/`
...
- **Registry doc**: `pages.registry.json` → `pages.annotation_cockpit._doc`
