# window_summary_table — per-window summary table — Page Capability Contract
...
## Sub-modules in `window_summary_table/`
...
- **Registry doc**: `pages.registry.json` → `pages.window_summary_table._doc`
