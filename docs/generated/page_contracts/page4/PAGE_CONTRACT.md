# page4 — karyotype / tier — Page Capability Contract
...
- **REGISTRY MISMATCH (flagged 2026-05-07 step 21)**:
  ...
  May be **swapped** with page11's declared `candidate_final_class` +
...
- **Registry doc**: `pages.registry.json` → `pages.page4._doc` (long,
