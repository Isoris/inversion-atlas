# multi_species_cockpit — multi-species classification cockpit — Page Capability Contract
...
## Reads from cross_species_breakpoints

- `state.crossSpecies` — active breakpoint catalogue from
  `cs_breakpoints_v1`. Cross-page dependency: if cross_species_breakpoints hasn't been
...
## Sub-modules in `multi_species_cockpit/`
...
- **Registry doc**: `pages.registry.json` → `pages.multi_species_cockpit._doc`
