# page17 — stats profile — Page Capability Contract
...
- Directory / stage discrepancy: `manifest.json` says
  ...
  `pages/catalogue/`.
- Cross-page runtime dependency on page16; see above.

## Documents

- **Registry doc**: `pages.registry.json` → `pages.page17._doc`
