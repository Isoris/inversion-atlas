# page7 — ancestry — Page Capability Contract
...
page7 is a **thin loader stub**, sibling of page6. The renderer
...
- **Registry doc**: `pages.registry.json` → `pages.page7._doc` (flags
  the mismatch)
