...
| discovery_2 | pca_comparator | PCA comparator (dosage · θπ · GHSL) | active (Phase 1) | high | [page.manifest.json](page_contracts/pca_comparator/page.manifest.json) · [PAGE_CONTRACT.md](page_contracts/pca_comparator/PAGE_CONTRACT.md) |
