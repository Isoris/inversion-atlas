...
| `SPEC_distant_band_concordance_fish_trajectory.md` | Fish-paths dual representation of band-track partition matrices. Slice 1: `runLineageCompute` (Hungarian-chain projection per L2). Slice 2: `lineage` lines color mode. Slice 3: |Z|-panel lineage strip + chain-break gaps. Slice 4: band-trace strip on user fish-set + Shannon entropy. Slice 5: TSV export. Slice 6 (cross-strip chaining) deferred. | `pages/discovery/page1/{lineage.js, band_trace_state.js, band_trace_tooltip.js}` + `shared/{band_trace.js, clustering.js, hungarian.js}` + `pages/discovery/page1/z_panel.js` (strip painters) |
