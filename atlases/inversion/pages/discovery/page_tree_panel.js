// pages/discovery/page_tree_panel.js
// =====================================================================
...
import { _pageState, _setActiveState } from './page_tree_panel/_state.js';
import {
  layoutFromMglTree,
  paintTree,
  findLeafAtPixel,
} from './page_tree_panel/renderer.js';
import {
  ariBetweenTreeAndClusters,
  createTreePanelSelection,
} from './page_tree_panel/selection.js';
...
export async function mount(root, atlasState, registry) {
  ...
  catch (e) { console.warn('page_tree_panel.mount: refresh threw —', e); }

  try { initTreePanelToolbar(); }
  catch (e) { console.warn('page_tree_panel.mount: toolbar wiring threw —', e); }
...
export async function unmount(root) {
  ...
  catch (e) { console.warn('page_tree_panel.unmount: teardown threw —', e); }
