...
//
// The caller — page1/_state.js `_lineageColor` — currently schedules
// this via requestIdleCallback after first reference. Once page1's
...
export function runLineageCompute(state, opts) {
  ...
  // Default getLabelsForL2: read from page1's L2-cluster cache.
