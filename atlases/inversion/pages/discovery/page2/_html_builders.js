// pages/discovery/page2/_html_builders.js
//
// HTML-builder sub-module for page2 (chat 36 round 5 step 2, 2026-05-07).
...
// as their first statement (page1 round 4 shim pattern). The shim is
// active because page2.js's entry points (renderCandidateMetadata,
...
// heatmap panel needs its own state initializer (page2-private).
...
// _ensureDosageHmState — legacy line 16795 (page2-private). Lazy-init
...
// --- candidateLocMiniHtml — extracted from legacy line 59024 (page2-private support) ---
// --- candidatePanelStubHtml — extracted from legacy line 59036 (page2-private support) ---
