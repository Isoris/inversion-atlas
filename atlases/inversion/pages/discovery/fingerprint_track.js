// pages/discovery/fingerprint_track.js
// =====================================================================
...
import { _pageState, _setActiveState } from './fingerprint_track/_state.js';
import {
  paintFingerprintTrack,
  findWindowAtPixel,
  findSwitchAtPixel,
  buildRegimeColorMap,
} from './fingerprint_track/renderer.js';
import {
  createFingerprintSelection,
  summariseWindow,
} from './fingerprint_track/selection.js';
import {
  paintRegimeProportions,
  findRegimeAtPixel,
} from './fingerprint_track/proportions.js';
import {
...
export async function mount(root, atlasState, registry) {
  ...
  catch (e) { console.warn('fingerprint_track.mount: refresh threw —', e); }

  try { initFingerprintTrackToolbar(); }
  catch (e) { console.warn('fingerprint_track.mount: toolbar wiring threw —', e); }
...
export async function unmount(root) {
  ...
  catch (e) { console.warn('fingerprint_track.unmount: teardown threw —', e); }
