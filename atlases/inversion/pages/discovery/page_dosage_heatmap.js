// pages/discovery/page_dosage_heatmap.js
// =====================================================================
...
import { _pageState, _setActiveState } from './page_dosage_heatmap/_state.js';
import {
  paintDosageHeatmap,
  findCellAtPixel,
  deriveSampleOrder,
  deriveMarkerOrder,
  buildGroupColorMap,
} from './page_dosage_heatmap/renderer.js';
import {
  adaptMglHeatmapJson,
  adaptLegacyChunk,
} from './page_dosage_heatmap/adapters.js';
import {
  createDosageHeatmapSelection,
  summariseHoverCell,
  groupSizesFromSampleGroup,
} from './page_dosage_heatmap/selection.js';
...
export async function mount(root, atlasState, registry) {
  ...
  catch (e) { console.warn('page_dosage_heatmap.mount: refresh threw —', e); }

  try { initDosageHeatmapToolbar(); }
  catch (e) { console.warn('page_dosage_heatmap.mount: toolbar wiring threw —', e); }
...
export async function unmount(root) {
  ...
  catch (e) { console.warn('page_dosage_heatmap.unmount: teardown threw —', e); }
