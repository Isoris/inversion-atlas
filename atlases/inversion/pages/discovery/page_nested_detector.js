// pages/discovery/page_nested_detector.js
// =====================================================================
...
import { _pageState, _setActiveState } from './page_nested_detector/_state.js';
import {
  paintNestedTracks,
  findBandAtPixel,
  findIntervalAtPixel,
  ...
  verdictLabel,
  stratumColor,
} from './page_nested_detector/renderer.js';
import {
  createNestedDetectorSelection,
  summariseInterval,
  candidateCountsByStratum,
} from './page_nested_detector/selection.js';
...
export async function mount(root, atlasState, registry) {
  ...
  catch (e) { console.warn('page_nested_detector.mount: refresh threw —', e); }

  try { initNestedDetectorToolbar(); }
  catch (e) { console.warn('page_nested_detector.mount: toolbar wiring threw —', e); }

  if (atlasState.inversion) {
    atlasState.inversion._page_nested_detector_state = pageState;
  }
}

export async function unmount(root) {
  try { _teardownToolbar(_pageState); }
  catch (e) { console.warn('page_nested_detector.unmount: teardown threw —', e); }
