// pages/discovery/local_pca_dosage/candidates.js
//
...
export function refreshCandidateUI(state) {
  // Update the candidate_focus tab to show a small dot when a candidate is active
  ...
  // Render the page 2 metadata block (candidate_focus-territory; guarded — candidate_focus may
  // not be loaded under the new shell when local_pca_dosage mounts).
...
export function setCandidate(state, cand) {
  ...
  // selection. Without this call the choice is local_pca_dosage-private and the rest
