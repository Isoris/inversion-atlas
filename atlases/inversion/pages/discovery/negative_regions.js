// Atlas/inversion_discovery/negative_regions.js
// =============================================================================
// negative_regions — Negative regions catalogue (complement of catalogue catalogue)
// (`<div id="negative_regions">` — toolbar with load/export/reset buttons,
//  caution banner, summary cards, region table)
//
// Source: legacy/Inversion_atlas.html lines 7378-7572 (HTML shell only)
//
// IMPORTANT: negative_regions's JS handlers do NOT exist in legacy/Inversion_atlas.html.
...
// negative_regions tab shows the static caution banner + empty summary cards.
//
// Confirmed by:
//   $ grep -n 'nrLoadBtn\|nrSummaryCards\|_nrRender' legacy/Inversion_atlas.html
//   (all hits are HTML/CSS/comments — no JS handlers)
// And by chat-33 BATCH_1_NOTES.md row for negative_regions: "0 functions extracted —
// pure HTML scaffold."
//
...
// renderers. This is the window_summary_table stub-preserving migration template
...
import { _pageState, _setActiveState } from './negative_regions/_state.js';
import {
  renderNegativeRegions,
  wireNegativeRegionsToolbar,
  teardownNegativeRegionsToolbar,
} from './negative_regions/negative_regions.js';
...
/**
 * Mount: called by atlas_router when the user navigates to negative_regions.
 *
...
export async function mount(root, atlasState, registry) {
  ...
  catch (e) { console.warn('negative_regions.mount: refreshNegativeRegions threw —', e); }

  try { initNegativeRegionsToolbar(); }
  catch (e) { console.warn('negative_regions.mount: initNegativeRegionsToolbar threw —', e); }
...
export async function unmount(root) {
  ...
  catch (e) { console.warn('negative_regions.unmount: teardown threw —', e); }
