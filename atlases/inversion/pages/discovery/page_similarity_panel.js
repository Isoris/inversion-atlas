// pages/discovery/page_similarity_panel.js
// =====================================================================
...
import { _pageState, _setActiveState } from './page_similarity_panel/_state.js';
import {
  ...
  deriveSampleOrder,
  buildBlockColorMap,
} from './page_similarity_panel/renderer.js';
import {
  createSimilarityPanelSelection,
  summariseWindow,
  blockSizesFromAssignment,
} from './page_similarity_panel/selection.js';
...
export async function mount(root, atlasState, registry) {
  ...
  catch (e) { console.warn('page_similarity_panel.mount: refresh threw —', e); }

  try { initSimilarityPanelToolbar(); }
  catch (e) { console.warn('page_similarity_panel.mount: toolbar wiring threw —', e); }

  if (atlasState.inversion) {
    atlasState.inversion._page_similarity_panel_state = pageState;
  }
}

export async function unmount(root) {
  try { _teardownToolbar(_pageState); }
  catch (e) { console.warn('page_similarity_panel.unmount: teardown threw —', e); }
