...
import { _pageState, _setActiveState } from './page18/_state.js';
...
/**
 * Mount: called by atlas_router when the user navigates to page18.
 *
 * Reads activeChrom from atlasState and builds a legacy-shape state
 * with the slots page18 needs: candidateList, crossSpecies,
...
export async function mount(root, atlasState, registry) {
  ...
  catch (e) { console.warn('page18.mount: renderMarkerPanelPage threw —', e); }
