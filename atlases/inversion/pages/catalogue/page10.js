...
// as page_overview (round 5 step 8).
// =====================================================================
...
//
// The new direct exports below give page10 the standard surface used by
// page9/17/18/21/page_overview: renderPage10(state), mount(), unmount().
...
/**
 * Mount: called by atlas_router when the user navigates to page10.
 *
 * Reads activeChrom from atlasState and builds a legacy-shape state with
 * the slots page10 reads: data (chromosome precomp with _layers_present,
...
export async function mount(root, atlasState, registry) {
  ...
  catch (e) { console.warn('page10.mount: renderPage10 threw —', e); }
