...
function _ackEnsureState() {
  // Read from page21's _pageState (set by mount() or refreshAnnotationCockpit(state)).
...
/**
 * Mount: called by atlas_router when the user navigates to page21.
 *
 * Reads activeChrom from atlasState and builds a legacy-shape state with
 * the slots page21 needs: data (chromosome precomp with samples + windows
...
export async function mount(root, atlasState, registry) {
  ...
  catch (e) { console.warn('page21.mount: refreshAnnotationCockpit threw —', e); }
