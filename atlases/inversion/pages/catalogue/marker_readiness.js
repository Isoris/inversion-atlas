// Atlas/inversion_catalogue/marker_readiness.js
// =============================================================================
// marker_readiness — Marker readiness panel (private-indel architecture)
// (`<div id="marker_readiness">` contains `<div id="mpBody">`)
//
...
// =============================================================================
// v4 turn 78 — Marker readiness panel (marker_readiness) — REBUILT for private-indel
...
export function renderMarkerPanelPage(state) {
  if (state) _setActiveState(state);
  return _renderMarkerPanelPage();
}

// ---------------------------------------------------------------------------
// Atlas-router lifecycle (chat 36 round 5 step 4, 2026-05-07).
// ---------------------------------------------------------------------------

/**
 * Mount: called by atlas_router when the user navigates to marker_readiness.
 *
 * Reads activeChrom from atlasState and builds a legacy-shape state
 * with the slots marker_readiness needs: candidateList, crossSpecies,
 * _markerPanel (lazy-init), markerThresholds (default-from-MP_AF_THRESHOLDS),
...
function _buildLegacyState(atlasState) {
  ...
  legacy.markerThresholds  = inv.markerThresholds  || null;
...
// stats_profile (stats profile) so it MUST be exported. The merge chat may
