// pages/evolution/archaeology_synthesis_card.js
// =====================================================================
...
export async function mount(root, atlasState, registry) {
  ...
  catch (e) { console.warn('archaeology_synthesis_card.mount: refresh threw —', e); }
  if (atlasState.inversion) {
    atlasState.inversion._page_archaeology_synthesis_card_state = pageState;
  }
}
