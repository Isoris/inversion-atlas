// pages/evolution/page_evolution_internal_history.js
// =====================================================================
// PCA on derived-only samples to surface sublineages inside the INV
// class. Reuses shared/mgl_pca_compute.pcaForWindow.
// =====================================================================

import { _pageState, _setActiveState } from './page_evolution_internal_history/_state.js';
...
export async function mount(root, atlasState, registry) {
  ...
  catch (e) { console.warn('page_evolution_internal_history.mount: refresh threw —', e); }
  if (atlasState.inversion) {
    atlasState.inversion._page_internal_history_state = pageState;
  }
}
