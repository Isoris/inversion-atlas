// pages/evolution/page_evolution_polarize_msa.js
// =====================================================================
...
import { _pageState, _setActiveState }
  from './page_evolution_polarize_msa/_state.js';
import {
  buildPolarizeMsaRows,
  polarizationVerdict,
  ROW_TAG,
} from './page_evolution_polarize_msa/builder.js';
import {
  paintDosageHeatmap,
  findCellAtPixel,
  paintTierStripe,
  rowTagColor,
  tierLabel,
} from './page_evolution_polarize_msa/renderer.js';
import {
  createPolarizeMsaSelection,
  summariseHover,
} from './page_evolution_polarize_msa/selection.js';
...
export async function mount(root, atlasState, registry) {
  ...
  catch (e) { console.warn('page_evolution_polarize_msa.mount: refresh threw —', e); }
  try { initPolarizeMsaToolbar(); }
  catch (e) { console.warn('page_evolution_polarize_msa.mount: toolbar threw —', e); }
  if (atlasState.inversion) {
    atlasState.inversion._page_polarize_msa_state = pageState;
  }
}

export async function unmount(root) {
  try { _teardownToolbar(_pageState); }
  catch (e) { console.warn('page_evolution_polarize_msa.unmount: teardown threw —', e); }
