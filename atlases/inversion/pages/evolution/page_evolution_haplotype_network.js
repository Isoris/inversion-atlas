// pages/evolution/page_evolution_haplotype_network.js
// =====================================================================
...
import { _pageState, _setActiveState }
  from './page_evolution_haplotype_network/_state.js';
import { buildHaplotypeNetwork } from '../../shared/mgl_haplotype_network.js';
import {
  paintHaplotypeNetwork,
  findNodeAtPixel,
  nodeColor,
} from './page_evolution_haplotype_network/renderer.js';
import {
  createHapNetSelection,
  summariseNode,
  summariseNetwork,
} from './page_evolution_haplotype_network/selection.js';
...
export async function mount(root, atlasState, registry) {
  ...
  catch (e) { console.warn('page_evolution_haplotype_network.mount: refresh threw —', e); }
  try { initHapNetToolbar(); }
  catch (e) { console.warn('page_evolution_haplotype_network.mount: toolbar threw —', e); }
...
export async function unmount(root) {
  ...
  catch (e) { console.warn('page_evolution_haplotype_network.unmount: teardown threw —', e); }
