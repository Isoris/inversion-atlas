// pages/evolution/page_evolution_event_tree.js
// =====================================================================
...
import { _pageState, _setActiveState } from './page_evolution_event_tree/_state.js';
...
export async function mount(root, atlasState, registry) {
  ...
  catch (e) { console.warn('page_evolution_event_tree.mount: refresh threw —', e); }
  if (atlasState.inversion) {
    atlasState.inversion._page_event_tree_state = pageState;
  }
}
