// pages/evolution/page_evolution_polarize_synteny.js
// =====================================================================
...
import { _pageState, _setActiveState }
  from './page_evolution_polarize_synteny/_state.js';
import {
...
export async function mount(root, atlasState, registry) {
  ...
  catch (e) { console.warn('page_evolution_polarize_synteny.mount: refresh threw —', e); }
  if (atlasState.inversion) {
    atlasState.inversion._page_polarize_synteny_state = pageState;
  }
}
