...
// ----------------------------------------------------------------------
// pages.registry.json declares page4 has
...
// This is a NEW shape of mismatch (distinct from page6 + page7 which
// were chromosome-level pages with candidate-* fields; here page4 is
...
// `final_classification` + `classification` (matching what page4
// actually consumes), or whether the candidate_sv_counts +
// candidate_boundaries entries are intended (page4 supposed to be
// repurposed?).
//
...
/**
 * Mount: called by atlas_router when the user navigates to page4.
 *
 * Builds a legacy-shape state with the slots page4 reads:
...
export async function mount(root, atlasState, registry) {
  ...
  catch (e) { console.warn('page4.mount: renderCandidateKaryotype threw —', e); }
...
function _buildLegacyState(atlasState) {
  ...
  // Transient slot — page4 reads state.data.final_classification +
