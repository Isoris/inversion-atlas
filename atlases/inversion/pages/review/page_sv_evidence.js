...
// this round, review tier-1 is closed (only page4, page11, page16b
// remain across the whole project).
//
// Extraction notes (Batch 2)
// --------------------------
// Unlike the other review pages (page6, page7), page_sv_evidence is NOT
...
// ---------------------------------------------------------------
// pages.registry.json declares page_sv_evidence has
...
// page_sv_evidence is genuinely a candidate-level view: the chat-33
...
// mismatch shape; page_sv_evidence does not.
// =============================================================================


import { _pageState, _setActiveState } from './page_sv_evidence/_state.js';
 ...
 * (mirrors page7/page6/page9/page15/page5 wrapper pattern). The chat-33
...
/**
 * Mount: called by atlas_router when the user navigates to page_sv_evidence.
 *
 * Builds a legacy-shape state with the slot page_sv_evidence reads
...
export async function mount(root, atlasState, registry) {
  ...
  catch (e) { console.warn('page_sv_evidence.mount: refreshPageSvEvidence threw —', e); }
...
export async function unmount(root) {
  ...
  catch (e) { console.warn('page_sv_evidence.unmount: hideSvEvidencePage threw —', e); }
