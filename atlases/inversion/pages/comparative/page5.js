// Atlas/inversion_comparative/page5.js
// =============================================================================
// page5 — Quick-reference / help page (static)
// (`<div id="page5">` — ~1158 LOC of declarative help/vocabulary/hotkeys/
...
// 5142 (data-page="page5" data-stage="help") and a single dispatch at line
...
//   HANDOFF_BATCH_5.md described page5 as 'Multi-species comparison page
...
//   actually the static QUICK-REFERENCE / HELP page (data-page='page5',
//   data-stage='help'). The actual multi-species cockpit is page16b
//   (lines 8033-8100; renderer _renderMultiSpeciesPage at legacy line
//   27497). page16b lives in page16b.js and remains unmigrated as of
//   round 5 step 16.
//
// Because page5 is purely declarative HTML (the help/vocabulary/hotkeys/
...
// true no-op that exists so the page-loader can dispatch to page5 the
// same way it dispatches to other pages (uniform routing).
//
// Round-5-step-16 status: stub-preserving + lifecycle scaffolding (page9
...
// lifecycle exist for future-proofing if page5 ever gains real
// renderable content.
//
// **Closing comparative tier-1**: with this round, page5 + page16 are
// both migrated; only page16b (2416 LOC multi-species cockpit) remains
...
// ---------------------------------------------------------------------------
// Chat-33 exports — PRESERVED VERBATIM (page5.js round-5-step-16, no
// behavioural change to the help-page contract).
// ---------------------------------------------------------------------------

/**
 * renderPage5 — chat-33 stub. Help page is static HTML; nothing to do at
 * render time. The HTML content lives in page5.html and is mounted by
 ...
 * tabBar router (data-page="page5", data-stage="help", num=16). The
 * `static: true` flag tells the loader page5 needs no JS render call.
 */
 ...
 * page9 / page15 wrapper pattern: if `state` is passed, sets _pageState
 * before delegating. Currently a degenerate case because renderPage5
 * itself is a no-op; the wrapper exists for future-proofing if page5
...
/**
 * Mount: called by atlas_router when the user navigates to page5.
 *
