...
const page  = await import(`${WORKSPACE}/atlases/inversion/pages/evolution/archaeology_synthesis_card.js`);
const state = await import(`${WORKSPACE}/atlases/inversion/pages/evolution/archaeology_synthesis_card/_state.js`);
