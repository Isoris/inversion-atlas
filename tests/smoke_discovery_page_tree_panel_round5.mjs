// tests/smoke_discovery_page_tree_panel_round5.mjs
//
...
const page = await import(`${WORKSPACE}/atlases/inversion/pages/discovery/page_tree_panel.js`);
const state = await import(`${WORKSPACE}/atlases/inversion/pages/discovery/page_tree_panel/_state.js`);
