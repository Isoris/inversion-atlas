...
// lifecycle smoke test for page_overview (synthesis-stage tab, empty
// in legacy).
//
...
const pageOv = await import(`${WORKSPACE}/atlases/inversion/pages/catalogue/page_overview.js`);
const state  = await import(`${WORKSPACE}/atlases/inversion/pages/catalogue/page_overview/_state.js`);
