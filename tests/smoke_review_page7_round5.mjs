...
// lifecycle smoke test for page7 (ancestry view — review stage).
...
const page7 = await import(`${WORKSPACE}/atlases/inversion/pages/review/page7.js`);
const state = await import(`${WORKSPACE}/atlases/inversion/pages/review/page7/_state.js`);
...
check('page7 has mount',                       typeof page7.mount === 'function');
check('page7 has unmount',                     typeof page7.unmount === 'function');
check('page7 has refreshPage7 (wrapper)',      typeof page7.refreshPage7 === 'function');
check('page7 has showAncestryPage (chat-33)',  typeof page7.showAncestryPage === 'function');
check('page7 has refreshAncestryPage (chat-33)',
      typeof page7.refreshAncestryPage === 'function');
...
try { await page7.mount(root, atlasState, registry); }
...
try { await page7.mount(root, atlasState2, registry); }
...
try { page7.refreshPage7(reRenderState); }
