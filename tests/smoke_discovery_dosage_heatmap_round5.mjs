// tests/smoke_discovery_dosage_heatmap_round5.mjs
//
...
const page  = await import(`${WORKSPACE}/atlases/inversion/pages/discovery/dosage_heatmap.js`);
const state = await import(`${WORKSPACE}/atlases/inversion/pages/discovery/dosage_heatmap/_state.js`);
