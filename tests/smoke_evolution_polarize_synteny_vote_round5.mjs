...
const page  = await import(`${WORKSPACE}/atlases/inversion/pages/evolution/polarize_synteny_vote.js`);
const state = await import(`${WORKSPACE}/atlases/inversion/pages/evolution/polarize_synteny_vote/_state.js`);
