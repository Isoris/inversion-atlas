// tests/smoke_discovery_nested_inversion_detector_round5.mjs

const WORKSPACE = process.env.WORKSPACE || '/home/user/inversion-atlas';
const page  = await import(`${WORKSPACE}/atlases/inversion/pages/discovery/nested_inversion_detector.js`);
const state = await import(`${WORKSPACE}/atlases/inversion/pages/discovery/nested_inversion_detector/_state.js`);
