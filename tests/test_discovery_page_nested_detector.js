// tests/test_discovery_page_nested_detector.js
//
// Unit coverage for pages/discovery/page_nested_detector — HANDOFF_7
// atlas-side cartridge.

import * as page from '../atlases/inversion/pages/discovery/page_nested_detector.js';
import * as state from '../atlases/inversion/pages/discovery/page_nested_detector/_state.js';
import {
  paintNestedTracks,
  findBandAtPixel,
  findIntervalAtPixel,
  ...
  verdictLabel,
  stratumColor,
} from '../atlases/inversion/pages/discovery/page_nested_detector/renderer.js';
import {
  createNestedDetectorSelection,
  summariseInterval,
  candidateCountsByStratum,
} from '../atlases/inversion/pages/discovery/page_nested_detector/selection.js';
