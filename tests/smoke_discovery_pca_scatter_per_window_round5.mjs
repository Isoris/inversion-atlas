// tests/smoke_discovery_pca_scatter_per_window_round5.mjs
//
...
const page  = await import(`${WORKSPACE}/atlases/inversion/pages/discovery/pca_scatter_per_window.js`);
const state = await import(`${WORKSPACE}/atlases/inversion/pages/discovery/pca_scatter_per_window/_state.js`);
