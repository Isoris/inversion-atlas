// tests/smoke_discovery_fingerprint_track_round5.mjs
//
...
const page = await import(`${WORKSPACE}/atlases/inversion/pages/discovery/fingerprint_track.js`);
const state = await import(`${WORKSPACE}/atlases/inversion/pages/discovery/fingerprint_track/_state.js`);
