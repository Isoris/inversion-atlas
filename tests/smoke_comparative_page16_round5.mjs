...
// lifecycle smoke test for page16 (cross-species breakpoints page —
...
//
// Strategic value: page16 owns _csGetSyntenyBlocks +
// _csPermutationTest, previously runtime-guarded in page17 (synthesis
...
const page16 = await import(`${WORKSPACE}/atlases/inversion/pages/comparative/page16.js`);
const state  = await import(`${WORKSPACE}/atlases/inversion/pages/comparative/page16/_state.js`);
...
// harnesses. Adds canvas-context shim because page16's render path uses
...
check('page16 has mount',                    typeof page16.mount === 'function');
check('page16 has unmount',                  typeof page16.unmount === 'function');
check('page16 has renderCrossSpeciesPage',   typeof page16.renderCrossSpeciesPage === 'function');
check('page16 has _renderCrossSpeciesPage',  typeof page16._renderCrossSpeciesPage === 'function');
check('page16 has _csGetSyntenyBlocks (page17 guard target)',
      typeof page16._csGetSyntenyBlocks === 'function');
check('page16 has _csPermutationTest (page17 guard target)',
      typeof page16._csPermutationTest === 'function');
check('page16 has CS_EVENT_DEF',
      page16.CS_EVENT_DEF && typeof page16.CS_EVENT_DEF === 'object');
...
try { await page16.mount(root, atlasState, registry); }
...
try { await page16.mount(root, atlasState2, registry); }
...
const blocks2 = page16._csGetSyntenyBlocks();
...
try { page16.renderCrossSpeciesPage(stashedState); }
...
try { computeResult = page16._csComputeSynteny(); }
