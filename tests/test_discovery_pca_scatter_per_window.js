// tests/test_discovery_pca_scatter_per_window.js
//
// Unit coverage for pages/discovery/pca_scatter_per_window — the per-window
// PCA scatter cartridge (SPEC_0 §10 Phase 1). Renderer + selection
// are pure JS; full mount/unmount lifecycle is exercised in the
// smoke (DOM polyfill).

import * as page from '../atlases/inversion/pages/discovery/pca_scatter_per_window.js';
import * as state from '../atlases/inversion/pages/discovery/pca_scatter_per_window/_state.js';
import {
  paintScrubberStrip,
  paintScatter,
  findWindowAtPixel,
  ...
  variancetoColor,
  axisRange,
} from '../atlases/inversion/pages/discovery/pca_scatter_per_window/renderer.js';
import {
  createPcaPanelSelection,
  summarisePcaResult,
  clusterSizesFromAssignment,
} from '../atlases/inversion/pages/discovery/pca_scatter_per_window/selection.js';
