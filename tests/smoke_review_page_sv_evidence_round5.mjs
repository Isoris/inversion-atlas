...
// unmount lifecycle smoke test for page_sv_evidence (SV evidence
...
// group: 2 of 5 → 3 of 5).
//
// page_sv_evidence is a thin loader stub for window.AtlasSVEvidence
...
// page_sv_evidence external renderer is an OBJECT with three
...
const svEv  = await import(`${WORKSPACE}/atlases/inversion/pages/review/page_sv_evidence.js`);
const state = await import(`${WORKSPACE}/atlases/inversion/pages/review/page_sv_evidence/_state.js`);
...
// element page_sv_evidence touches is #sv_evidence_root (innerHTML +
...
check('page_sv_evidence has mount',
      typeof svEv.mount === 'function');
check('page_sv_evidence has unmount',
      typeof svEv.unmount === 'function');
check('page_sv_evidence has refreshPageSvEvidence (wrapper)',
      typeof svEv.refreshPageSvEvidence === 'function');
check('page_sv_evidence has showSvEvidencePage (chat-33)',
      typeof svEv.showSvEvidencePage === 'function');
check('page_sv_evidence has hideSvEvidencePage (chat-33)',
