// tests/smoke_discovery_dosage_cluster_adaptive_k_round5.mjs

const WORKSPACE = process.env.WORKSPACE || '/home/user/inversion-atlas';
const page  = await import(`${WORKSPACE}/atlases/inversion/pages/discovery/dosage_cluster_adaptive_k.js`);
const state = await import(`${WORKSPACE}/atlases/inversion/pages/discovery/dosage_cluster_adaptive_k/_state.js`);
