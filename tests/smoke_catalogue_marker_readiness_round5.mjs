...
// lifecycle smoke test for marker_readiness (marker readiness panel).
//
...
check('marker_readiness has mount',                    typeof marker_readiness.mount === 'function');
check('marker_readiness has unmount',                  typeof marker_readiness.unmount === 'function');
check('marker_readiness has renderMarkerPanelPage',    typeof marker_readiness.renderMarkerPanelPage === 'function');
...
try { await marker_readiness.mount(root, atlasState, registry); }
...
try { await marker_readiness.mount(root, atlasState2, registry); }
...
try { marker_readiness.renderMarkerPanelPage(stashedState); }
...
try { const panel = marker_readiness._mpDeriveAutoPanel(); derivedOK = Array.isArray(panel); }
...
try { await marker_readiness.unmount(root); }
