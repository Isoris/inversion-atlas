// tests/test_page11_boundaries_ui.js
//
// Unit coverage for page11's boundary-refinement UI module.
...
import * as UI from '../atlases/inversion/pages/review/page11/boundaries_ui.js';
import { ensureBoundariesState } from '../atlases/inversion/pages/review/page11/boundaries.js';
...
global.document = {
  ...
  querySelectorAll: (sel) => {
    if (sel === '#page11 .bnd-radius-btn') return _radiusBtns;
    return [];
  },
  querySelector: (sel) => {
    if (sel === '#page11 .bnd-radius-group') return _radiusGroup;
    return null;
  },
