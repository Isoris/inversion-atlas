...
//
// Unit coverage for pages/evolution/page_evolution_polarize_msa.
// Renderer + builder + selection + verdict are pure; mount/unmount
// lifecycle is exercised in the smoke.

import * as page from '../atlases/inversion/pages/evolution/page_evolution_polarize_msa.js';
import * as state from '../atlases/inversion/pages/evolution/page_evolution_polarize_msa/_state.js';
import {
  buildPolarizeMsaRows,
  polarizationVerdict,
  ROW_TAG,
} from '../atlases/inversion/pages/evolution/page_evolution_polarize_msa/builder.js';
import {
  paintTierStripe,
  rowTagColor,
  tierLabel,
} from '../atlases/inversion/pages/evolution/page_evolution_polarize_msa/renderer.js';
import {
  createPolarizeMsaSelection,
  summariseHover,
} from '../atlases/inversion/pages/evolution/page_evolution_polarize_msa/selection.js';
