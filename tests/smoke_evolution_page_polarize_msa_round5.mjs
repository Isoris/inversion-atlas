...
const page  = await import(`${WORKSPACE}/atlases/inversion/pages/evolution/page_evolution_polarize_msa.js`);
const state = await import(`${WORKSPACE}/atlases/inversion/pages/evolution/page_evolution_polarize_msa/_state.js`);
