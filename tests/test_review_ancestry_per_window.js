...
//
// Sub-module + main re-export coverage for the ancestry_per_window ancestry view
// (lifecycle scaffolding + verbatim chat-33 thin-loader exports).
//
// Round 5 step 17 (chat 38, 2026-05-07): ancestry_per_window promoted from chat-33
...
// -----------------------------------------------------------------------------
group('ancestry_per_window.js: lifecycle entry-points');
check('exports mount',                       typeof ancestry_per_window.mount === 'function');
check('exports unmount',                     typeof ancestry_per_window.unmount === 'function');
check('exports refreshPage7 (wrapper)',      typeof ancestry_per_window.refreshPage7 === 'function');
check('__MODULE_ID__ NOT exported',          !('__MODULE_ID__' in ancestry_per_window));

// -----------------------------------------------------------------------------
group('ancestry_per_window.js: chat-33 thin-loader exports preserved verbatim');
check('exports showAncestryPage',            typeof ancestry_per_window.showAncestryPage === 'function');
check('exports refreshAncestryPage',         typeof ancestry_per_window.refreshAncestryPage === 'function');
...
try { ancestry_per_window.showAncestryPage({ candidate: null }); }
...
try { ancestry_per_window.refreshAncestryPage(); }
...
ancestry_per_window.refreshPage7(synthState);
...
try { ancestry_per_window.refreshPage7(); }
