...
const page  = await import(`${WORKSPACE}/atlases/inversion/pages/evolution/event_tree_relative_ordering.js`);
const state = await import(`${WORKSPACE}/atlases/inversion/pages/evolution/event_tree_relative_ordering/_state.js`);
