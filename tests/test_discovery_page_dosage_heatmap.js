// tests/test_discovery_page_dosage_heatmap.js
//
// Unit coverage for pages/discovery/page_dosage_heatmap — sample × marker
...
import * as page from '../atlases/inversion/pages/discovery/page_dosage_heatmap.js';
import * as state from '../atlases/inversion/pages/discovery/page_dosage_heatmap/_state.js';
import {
  paintDosageHeatmap,
  findCellAtPixel,
  deriveSampleOrder,
  ...
  buildGroupColorMap,
  dosageValueToColor,
} from '../atlases/inversion/pages/discovery/page_dosage_heatmap/renderer.js';
import {
  adaptMglHeatmapJson,
  adaptLegacyChunk,
} from '../atlases/inversion/pages/discovery/page_dosage_heatmap/adapters.js';
import {
  createDosageHeatmapSelection,
  summariseHoverCell,
  groupSizesFromSampleGroup,
} from '../atlases/inversion/pages/discovery/page_dosage_heatmap/selection.js';
