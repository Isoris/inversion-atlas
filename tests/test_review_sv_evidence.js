...
//
// Sub-module + main re-export coverage for the sv_evidence
// SV-evidence view (lifecycle scaffolding + verbatim chat-33
// thin-loader exports).
//
// Round 5 step 19 (chat 39, 2026-05-07): sv_evidence promoted
...
// imported from `../inversion_review/sv_evidence.js` (pre-migration
// path) and was not run by the harness.

import * as svEv from '../atlases/inversion/pages/review/sv_evidence.js';
import * as state from '../atlases/inversion/pages/review/sv_evidence/_state.js';
...
// -----------------------------------------------------------------------------
group('sv_evidence.js: lifecycle entry-points');
...
// -----------------------------------------------------------------------------
group('sv_evidence.js: chat-33 thin-loader exports preserved verbatim');
