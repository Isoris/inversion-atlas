...
//
// Sub-module + main re-export coverage for the overview synthesis tab.
//
// Round 5 step 8 (chat 36, 2026-05-07): overview refactored from
...
import * as pageOv from '../atlases/inversion/pages/catalogue/overview.js';
import * as state  from '../atlases/inversion/pages/catalogue/overview/_state.js';
...
// -----------------------------------------------------------------------------
group('overview.js: lifecycle entry-points (NEW round 5 step 8)');
...
// -----------------------------------------------------------------------------
group('overview.js: backward-compat factory (legacy chat-33 surface)');
