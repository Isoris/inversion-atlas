// tests/test_discovery_page_tree_panel.js
//
// Unit coverage for pages/discovery/page_tree_panel — the HANDOFF_5
// atlas-side tree panel cartridge. Renderer + selection are pure
// JS; the full mount/unmount lifecycle is exercised in the smoke
// (DOM polyfill).

import * as page from '../atlases/inversion/pages/discovery/page_tree_panel.js';
import * as state from '../atlases/inversion/pages/discovery/page_tree_panel/_state.js';
import {
  layoutFromMglTree,
  paintTree,
  findLeafAtPixel,
} from '../atlases/inversion/pages/discovery/page_tree_panel/renderer.js';
import {
  ariBetweenTreeAndClusters,
  createTreePanelSelection,
} from '../atlases/inversion/pages/discovery/page_tree_panel/selection.js';
