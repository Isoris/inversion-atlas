...
// unmount lifecycle smoke test for page6 (popstats track stack —
// review stage). **Direct twin of page7's smoke** (shipped step 17);
...
const page6 = await import(`${WORKSPACE}/atlases/inversion/pages/review/page6.js`);
const state = await import(`${WORKSPACE}/atlases/inversion/pages/review/page6/_state.js`);
...
// -----------------------------------------------------------------------------
// Minimal DOM polyfill — same shape as page7 smoke plus #psNoChrom +
...
check('page6 has mount',                       typeof page6.mount === 'function');
check('page6 has unmount',                     typeof page6.unmount === 'function');
check('page6 has refreshPage6 (wrapper)',      typeof page6.refreshPage6 === 'function');
check('page6 has showPopstatsPage (chat-33)',  typeof page6.showPopstatsPage === 'function');
check('page6 has refreshPopstatsPage (chat-33)',
      typeof page6.refreshPopstatsPage === 'function');
...
try { await page6.mount(root, atlasState, registry); }
...
try { await page6.mount(root, atlasState2, registry); }
...
try { page6.refreshPage6(reRenderState); }
