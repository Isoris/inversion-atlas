// tests/test_discovery_page_dosage_cluster.js
//
// Unit coverage for pages/discovery/page_dosage_cluster — HANDOFF_8
// atlas-side cartridge.

import * as page from '../atlases/inversion/pages/discovery/page_dosage_cluster.js';
import * as state from '../atlases/inversion/pages/discovery/page_dosage_cluster/_state.js';
import {
  paintClusterCurves,
  findClusterAtPixel,
  curvesRange,
  ...
  verdictLabel,
  clusterColor,
} from '../atlases/inversion/pages/discovery/page_dosage_cluster/renderer.js';
import {
  createDosageClusterSelection,
  summariseKEntry,
  entryToDisplay,
  clusterSizesFromLabels,
} from '../atlases/inversion/pages/discovery/page_dosage_cluster/selection.js';
