...
const page  = await import(`${WORKSPACE}/atlases/inversion/pages/evolution/page_evolution_haplotype_network.js`);
const state = await import(`${WORKSPACE}/atlases/inversion/pages/evolution/page_evolution_haplotype_network/_state.js`);
