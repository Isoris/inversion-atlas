...
// smoke test for help (quick-reference / help page — comparative tier-1
// closeout).
//
...
const help = await import(`${WORKSPACE}/atlases/inversion/pages/comparative/help.js`);
const state = await import(`${WORKSPACE}/atlases/inversion/pages/comparative/help/_state.js`);
...
check('help has mount',                   typeof help.mount === 'function');
check('help has unmount',                 typeof help.unmount === 'function');
check('help has refreshPage5 (wrapper)',  typeof help.refreshPage5 === 'function');
check('help has renderPage5 (chat-33)',   typeof help.renderPage5 === 'function');
check('help has PAGE5_META',              typeof help.PAGE5_META === 'object');

// -----------------------------------------------------------------------------
group('PAGE5_META shape (used by tabBar router at legacy line 5142)');
check('PAGE5_META.id === "help"',         help.PAGE5_META.id === 'help');
check('PAGE5_META.stage === "help"',       help.PAGE5_META.stage === 'help');
check('PAGE5_META.static === true',        help.PAGE5_META.static === true);
...
try { await help.mount(root, atlasState, registry); }
...
try { await help.mount(root, atlasState2, registry); }
...
try { help.refreshPage5(reRunState); }
